...
- **STT**: Parakeet TDT 0.6B runs locally via FluidAudio CoreML on ANE (v3 default, v2 English-only opt-in), with optional local WhisperKit for broader language coverage (ADR-001, ADR-007, ADR-021)
