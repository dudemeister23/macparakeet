...
| [2026-06-19-boundary-contracts](active/2026-06-19-boundary-contracts.md) | Boundary contract docs + contract tests | **EXECUTOR-READY** | P2 | Create `spec/contracts/` and the first three tested contracts: meeting artifacts, meeting recovery/retention safety, and CLI JSON/spec output. Keep boundary behavior close to tests through lightweight Markdown contracts linked to XCTest. |
